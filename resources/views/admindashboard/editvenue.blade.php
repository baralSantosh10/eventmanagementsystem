            ...
            <div class="card shadow ">
                <div class="card-header ">
                    ...
                    <a href="{{ route('addvenue') }}" style="float:right;" class="btn btn-primary btn-icon-split ">
                        ...
                        <span class="text">List Venue</span>
                    </a>
                </div>
                <div class="card-body ">

                    <form action="{{ route('venue.update', ['id' => $editvenue->id]) }}" method="post">
                        @csrf
                        <div class="form-group">
                            <label for="exampleInputEmail1">Title</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" value="{{$editvenue->title}}" aria-describedby="emailHelp"
